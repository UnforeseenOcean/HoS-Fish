		...
		if(data.articleList && data.articleList.length > 0){
			...
			for(var i=0; i<data.articleList.length; i++){
				...
				if(data.articleList[i].anonymouse){
					...
					var rolecodeImg = (data.articleList[i].rolecode && data.articleList[i].rolecode != "1Z")? "<img src='http://i1.daumcdn.net/cafeimg/cf_img2/bbs2/roleicon/"+CAFEAPP.ui.ROLEICONTYPE+"_level_"+data.articleList[i].rolecode+".gif' width='14' height='14' alt='회원등급' />" : "";
